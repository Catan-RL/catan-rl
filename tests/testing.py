...
import catan_agent.ppo.utils as utils

from catan_agent.ppo.arguments import get_args
from catan_agent.ppo.game_manager import make_game_manager
from catan_agent.ppo.vec_gather_experience import SubProcGameManager
from catan_agent.models.build_agent_model import build_agent_model
from catan_agent.ppo.process_batch import BatchProcessor
from catan_agent.ppo.update_opponent_policies import update_opponent_policies
from catan_agent.ppo.run_evaluation_protocol import run_evaluation_protocol
from catan_agent.ppo.ppo import PPO
from catan_agent.ppo.vec_evaluation import SubProcEvaluationManager
from catan_agent.ppo.evaluation_manager import make_evaluation_manager
...
def main():
    ...
    experiment_dir = "catan_agent/results"
