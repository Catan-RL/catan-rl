...
class Style:
    ...
    @classmethod
    def _get_font(cls):
        pattern = "{font(_name)? ('|\")(?P<font>[A-Za-z0-9_ -]+" "(?P<ext>.ttf))('|\")}"
        ...
        cls.string = re.sub(
            ("({font(_name)? ('|\")([A-Za-z0-9_ -]+" "(.ttf)?)('|\")})"), "", cls.string
        )
        return font
    ...
    def _get_separate_italic(cls):
        ...
        cls.string = re.sub(
            ("({separate_italic ('|\")([A-Za-z0-9_ -]+" "(.ttf)?)('|\")})"),
            "",
            cls.string,
        )
    ...
    def _get_separate_bolditalic(cls):
        ...
        if searchgroup:
            if searchgroup.group("ext"):
                ...
                separate_bolditalic = searchgroup.group("separate_bolditalic") + ".ttf"
