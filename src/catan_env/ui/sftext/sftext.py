...
import catan_env.ui.sftext.resources as resources
from catan_env.ui.sftext.style.style import Style
...
class SFText:
    ...
    def parse_text(self):
        ...
        self.default_style["w"], self.default_style["h"] = self.default_style[
            "font_obj"
        ].size(" ")
                ...
                for i in range(len(wrapped)):
                    ...
                    while not fit:
                        ...
                        if False:
                            fit_iter += 1
                            print(
                                "fit iteraions: {}, iter_length: {}".format(
