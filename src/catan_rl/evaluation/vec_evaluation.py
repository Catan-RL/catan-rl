            ...
            if cmd == "initialise_policy_pool":
                ...
                for ep in range(num_episodes):
                    ...
                    if evaluation_manager.detailed_logging:
                        ...
                        detailed_action_out = [
                            item for sublist in detailed_action_out for item in sublist
                        ]
...
class SubProcEvaluationManager(object):
    def __init__(self, evaluation_manager_fns, start_method=None):
        ...
        for work_remote, remote, evaluation_manager_fn in zip(
            self.work_remotes, self.remotes, evaluation_manager_fns
        ):
